YUI.add("playerlist", function(Y) {
	...
	Y.PlayerView = Y.Base.create('playerview',Y.View,[],
	{
		initializer: function()
		{
			...
			{
				var src ='ready.png';
				c.append('<div class="playerlistentry"><div class="'+('playerlistentryname_green')+' playernameentery">'+m.get('login_name')+'</div><div class="playerlistentrycheckbox"><img id="ready_'+m.get('id')+'" src="../lobby/images/trans.png"/></div></div>');
			}
		},
		render: function()
		{
